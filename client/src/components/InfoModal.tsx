      ...
      >
        ...
        <div className="flex items-start justify-between gap-3 mb-3">
          ...
          <button
            ...
            onClick={() => setOpen(false)}
            className="flex-shrink-0 w-6 h-6 rounded-full flex items-center justify-center transition-colors" style={{ color: "var(--muted-foreground)" }}
          >
  ...
  const modal = open ? (
    ...
    >
      ...
      <div
        ...
        style={{ background: "var(--card)", border: "1px solid var(--border)", maxWidth: 'min(400px, 90vw)', width: '100%' }}
      >
        {/* Header */}
        <div className="flex items-start justify-between gap-3 mb-3">
          <div className="flex items-center gap-2">
        ...
        {/* Formel */}
        {formel && (
          <div className="mb-3 px-3 py-2 rounded-lg" style={{ background: "var(--muted)", border: "1px solid var(--border)" }}>
