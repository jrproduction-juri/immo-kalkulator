    ...
    <div className="min-h-screen" >
      ...
      <main className="max-w-3xl mx-auto px-4 sm:px-6 py-12">
        ...
        <section className="mb-8">
          <h2 className="font-semibold text-lg text-foreground mb-3">1. Allgemeine Hinweise</h2>
        ...
        <section className="mb-8">
          <h2 className="font-semibold text-lg text-foreground mb-3">2. Verantwortliche Stelle</h2>
        ...
        <section className="mb-8">
          <h2 className="font-semibold text-lg text-foreground mb-3">3. Erhebung und Speicherung personenbezogener Daten</h2>
        ...
        <section className="mb-8">
          <h2 className="font-semibold text-lg text-foreground mb-3">4. Nutzerkonto und Authentifizierung</h2>
          <div className="text-gray-700 leading-relaxed space-y-3">
        ...
        <section className="mb-8">
          <h2 className="font-semibold text-lg text-foreground mb-3">5. Nutzung des Immobilien-Analyse-Tools</h2>
          <div className="text-gray-700 leading-relaxed space-y-3">
        ...
        <section className="mb-8">
          <h2 className="font-semibold text-lg text-foreground mb-3">6. Zahlungsabwicklung (Stripe)</h2>
          <div className="text-gray-700 leading-relaxed space-y-3">
        ...
        <section className="mb-8">
          <h2 className="font-semibold text-lg text-foreground mb-3">7. Webanalyse (Umami Analytics)</h2>
          <div className="text-gray-700 leading-relaxed space-y-3">
        ...
        <section className="mb-8">
          <h2 className="font-semibold text-lg text-foreground mb-3">8. Cookies</h2>
          <div className="text-gray-700 leading-relaxed space-y-3">
        ...
        <section className="mb-8">
          <h2 className="font-semibold text-lg text-foreground mb-3">9. Ihre Rechte</h2>
          <div className="text-gray-700 leading-relaxed space-y-3">
        ...
        <section className="mb-8">
          <h2 className="font-semibold text-lg text-foreground mb-3">10. Datensicherheit</h2>
          <p className="text-gray-700 leading-relaxed">
        ...
        <section className="mb-8">
          <h2 className="font-semibold text-lg text-foreground mb-3">11. Änderungen dieser Datenschutzerklärung</h2>
          <p className="text-gray-700 leading-relaxed">
      ...
      <footer className="py-6 mt-8">
        <div className="max-w-3xl mx-auto px-4 sm:px-6 flex flex-wrap gap-4 justify-center text-xs text-muted-foreground">
