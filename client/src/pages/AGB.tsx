  ...
  return (
    <div className="min-h-screen" >
      ...
      <main className="max-w-3xl mx-auto px-4 sm:px-6 py-12">
        <h1 className="font-bold text-3xl text-foreground mb-2">Allgemeine Geschäftsbedingungen (AGB)</h1>
        <p className="text-gray-500 text-sm mb-10">Stand: März 2026 · ImmoRenditeTool von Juri Telipko / JR Production</p>

        <section className="mb-8">
          <h2 className="font-semibold text-lg text-foreground mb-3">1. Geltungsbereich</h2>
        ...
        <section className="mb-8">
          <h2 className="font-semibold text-lg text-foreground mb-3">2. Leistungsbeschreibung</h2>
          <div className="text-gray-700 leading-relaxed space-y-2">
        ...
        <section className="mb-8">
          <h2 className="font-semibold text-lg text-foreground mb-3">3. Registrierung und Nutzerkonto</h2>
          <div className="text-gray-700 leading-relaxed space-y-2">
        ...
        <section className="mb-8">
          <h2 className="font-semibold text-lg text-foreground mb-3">4. Preise und Zahlungsbedingungen</h2>
          <div className="text-gray-700 leading-relaxed space-y-2">
        ...
        <section className="mb-8">
          <h2 className="font-semibold text-lg text-foreground mb-3">5. Widerrufsrecht</h2>
          <div className="text-gray-700 leading-relaxed space-y-2">
        ...
        <section className="mb-8">
          <h2 className="font-semibold text-lg text-foreground mb-3">6. Haftungsausschluss</h2>
          <div className="text-gray-700 leading-relaxed space-y-2">
        ...
        <section className="mb-8">
          <h2 className="font-semibold text-lg text-foreground mb-3">7. Verfügbarkeit</h2>
        ...
        <section className="mb-8">
          <h2 className="font-semibold text-lg text-foreground mb-3">8. Nutzungsrechte und geistiges Eigentum</h2>
          <div className="text-gray-700 leading-relaxed space-y-2">
        ...
        <section className="mb-8">
          <h2 className="font-semibold text-lg text-foreground mb-3">9. Änderungen</h2>
          <p className="text-gray-700 leading-relaxed">
        ...
        <section className="mb-8">
          <h2 className="font-semibold text-lg text-foreground mb-3">10. Schlussbestimmungen</h2>
          <div className="text-gray-700 leading-relaxed space-y-2">
