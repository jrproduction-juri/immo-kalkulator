    ...
    <div className="min-h-screen" >
      ...
      <main className="max-w-3xl mx-auto px-4 sm:px-6 py-12">
        ...
        <section className="mb-8">
          <h2 className="font-semibold text-lg text-foreground mb-3">Anbieter</h2>
        ...
        <section className="mb-8">
          <h2 className="font-semibold text-lg text-foreground mb-3">Kontakt</h2>
        ...
        <section className="mb-8">
          <h2 className="font-semibold text-lg text-foreground mb-3">Umsatzsteuer</h2>
          <div className="text-gray-700 leading-relaxed">
        ...
        <section className="mb-8">
          <h2 className="font-semibold text-lg text-foreground mb-3">Verantwortlich für den Inhalt nach § 55 Abs. 2 MStV</h2>
          <div className="text-gray-700 leading-relaxed space-y-1">
            <p>Juri Telipko</p>
            <p>Römerallee 5</p>
            <p>50127 Bergheim</p>
        ...
        <section className="mb-8">
          <h2 className="font-semibold text-lg text-foreground mb-3">Haftungsausschluss</h2>
        ...
        <section className="mb-8">
          <h2 className="font-semibold text-lg text-foreground mb-3">Online-Streitbeilegung</h2>
          <div className="text-gray-700 leading-relaxed">
