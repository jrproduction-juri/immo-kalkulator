...
const PLAN_BADGE: Record<string, { label: string; style: React.CSSProperties }> = {
  none: { label: "Free", style: { background: 'var(--muted)', color: 'var(--muted-foreground)' } },
  basic: { label: "Basic", style: { background: 'rgba(59,130,246,0.15)', color: '#60A5FA' } },
  pro: { label: "Pro", style: { background: 'var(--gold)', color: 'var(--accent-foreground)' } },
      ...
      <div className="max-w-6xl mx-auto px-4 sm:px-6 py-8">
        ...
        {plan === "trial" && trialDaysLeft !== null && (
          ...
          >
            ...
            <button
              ...
              className="px-4 py-2 rounded-lg text-sm font-semibold text-foreground shrink-0 transition-all"
        ...
        <div className="flex items-center justify-between mb-8">
          ...
          <button
            ...
            className="flex items-center gap-2 px-5 py-2.5 rounded-xl font-bold text-sm text-foreground transition-all"
            style={{ background: 'linear-gradient(135deg, #1d4ed8, #3b82f6)' }}
        ...
        <div className="grid grid-cols-2 md:grid-cols-4 gap-3 mb-8">
          {[
            ...
            >
              {proOnly && (
                <div
                  className="absolute top-2 right-2 px-1.5 py-0.5 rounded text-xs font-bold btn-gold"
                >
                  Pro
                </div>
              )}
              ...
              <p className="font-semibold text-sm text-foreground" style={{ fontFamily: 'Sora, sans-serif' }}>
                {title}
              </p>
        ...
        <div className="mb-6">
          ...
          {immobilienQuery.isLoading ? (
            ...
            >
              ...
              <button
                onClick={() => navigate("/kalkulator")}
                className="inline-flex items-center gap-2 px-6 py-3 rounded-xl font-bold text-sm text-foreground transition-all"
                style={{ background: 'linear-gradient(135deg, #1d4ed8, #3b82f6)' }}
              >
                <Plus className="w-4 h-4" />
        ...
        {isFree && (
          ...
          >
            ...
            <div className="relative flex flex-col sm:flex-row items-start sm:items-center gap-5">
              ...
              <button
                onClick={() => navigate("/pricing")}
                className="flex items-center gap-2 px-5 py-2.5 rounded-xl font-bold text-sm text-foreground shrink-0 transition-all"
                style={{
        ...
        {isBasic && !isInvestor && (
          ...
          >
            ...
            <button
              onClick={() => navigate("/pricing")}
              className="flex items-center gap-2 px-4 py-2 rounded-lg font-bold text-sm shrink-0 transition-all btn-gold"
            >
