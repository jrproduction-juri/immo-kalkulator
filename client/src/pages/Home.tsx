    ...
    <div className="min-h-screen bg-background">
      ...
      >
        <div className="max-w-6xl mx-auto px-4 sm:px-6 h-16 flex items-center justify-between">
          <a href="/" className="flex items-center gap-2.5">
            ...
            <span className="font-bold text-foreground text-lg" style={{ fontFamily: 'Sora, sans-serif' }}>
              ImmoRenditeTool
            </span>
          </a>
          <div className="flex items-center gap-3">
            ...
            <button
              onClick={handleLogin}
              className="text-sm font-bold px-5 py-2 rounded-lg transition-all text-foreground"
              style={{ background: 'linear-gradient(135deg, #1d4ed8, #3b82f6)' }}
      ...
      >
        ...
        <div className="relative max-w-6xl mx-auto px-4 sm:px-6 py-28 md:py-36">
          ...
          <div className="flex flex-wrap items-center justify-center gap-4 mb-16">
            <button
              onClick={handleLogin}
              className="flex items-center gap-2 px-8 py-4 rounded-xl font-bold text-base text-foreground transition-all"
              style={{
      ...
      >
        <div className="max-w-6xl mx-auto px-4 sm:px-6">
          <div className="text-center mb-16">
            ...
            <p style={{ color: 'var(--muted-foreground)' }} className="text-lg max-w-xl mx-auto">
          ...
          <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-4 mb-8">
            ...
            >
              ...
              <p className="text-xs" style={{ color: 'var(--muted-foreground)' }}>pro Monat</p>
              <div className="mt-4">
                ...
                <p className="text-xs mt-1" style={{ color: 'var(--muted-foreground)' }}>72% positiver Cashflow</p>
              </div>
            </div>
            ...
            >
              ...
              <p className="text-xs" style={{ color: 'var(--muted-foreground)' }}>p.a. — sehr gut</p>
              <div className="mt-4">
                <div className="progress-bar-track">
                  <div
                    className="progress-bar-fill"
                ...
                <p className="text-xs mt-1" style={{ color: 'var(--muted-foreground)' }}>Über Marktdurchschnitt</p>
              </div>
            </div>
            ...
            >
              ...
              <div className="mt-4">
                ...
                <p className="text-xs mt-1" style={{ color: 'var(--muted-foreground)' }}>Hebeleffekt aktiv</p>
              </div>
            </div>
            ...
            >
              ...
              <p className="text-xs" style={{ color: 'var(--muted-foreground)' }}>Score: 82 / 100</p>
              <div className="mt-4">
                <div className="progress-bar-track">
                  <div
                    className="progress-bar-fill"
                ...
                <p className="text-xs mt-1" style={{ color: 'var(--muted-foreground)' }}>Empfehlung: Kaufen</p>
              </div>
            </div>
          </div>
            ...
            <div className="flex items-start gap-4">
              ...
              <div className="flex-1">
                <div className="flex items-center gap-2 mb-2">
                  <p className="font-bold text-foreground text-sm" style={{ fontFamily: 'Sora, sans-serif' }}>
          ...
          <div className="grid grid-cols-1 md:grid-cols-2 gap-6 max-w-4xl mx-auto">
            ...
            >
              <div className="mb-6">
                ...
                <p className="font-bold text-2xl text-foreground mt-3 mb-1" style={{ fontFamily: 'Sora, sans-serif' }}>
                  Kostenlos
                </p>
            ...
            >
              {/* Popular badge */}
              <div
                className="absolute top-4 right-4 px-3 py-1 rounded-full text-xs font-bold btn-gold"
              >
                BELIEBTESTE WAHL
              </div>
              ...
              <div className="mb-6">
                <span className="badge-pro">Pro</span>
                <p className="font-bold text-2xl text-foreground mt-3 mb-1" style={{ fontFamily: 'Sora, sans-serif' }}>
                  ab 19 €<span className="text-base font-normal" style={{ color: 'var(--muted-foreground)' }}>/Monat</span>
                </p>
                <p style={{ color: 'var(--muted-foreground)' }} className="text-sm">
              ...
              <button
                onClick={handleLogin}
                className="w-full mt-8 py-3 rounded-xl font-bold text-sm transition-all text-foreground"
                style={{
                  background: 'linear-gradient(135deg, #1d4ed8, #3b82f6)',
          ...
          <div className="space-y-3">
            {[
              ...
              >
                ...
                >
                  <span
                    className="font-semibold text-sm pr-4 font-display" style={{ color: openFaq === i ? 'var(--foreground)' : 'var(--foreground)' }}
                  >
                    {q}
                  </span>
                  <ChevronDown
      ...
      >
        ...
        <div className="relative max-w-2xl mx-auto px-4 sm:px-6 text-center">
          ...
          <button
            onClick={handleLogin}
            className="inline-flex items-center gap-2 px-10 py-4 rounded-xl font-bold text-base text-foreground transition-all"
            style={{
              background: 'linear-gradient(135deg, #1d4ed8, #3b82f6)',
          ...
          <div className="flex flex-wrap gap-5 justify-center">
            {[
              ...
              <a
                ...
                style={{ color: 'var(--muted-foreground)' }}
                onMouseEnter={e => ((e.currentTarget as HTMLElement).style.color = 'var(--muted-foreground)')}
